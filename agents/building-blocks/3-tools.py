...
def call_llm_with_tools(prompt: str) -> str:
    ...
    # IF the LLM decides he wants to call a tool we will have this type of response in the response.output
    # [{
    # "type": "function_call",
    # "id": "fc_12345xyz",
...
if __name__ == "__main__":
    result = call_llm_with_tools(prompt="What's the weather like in Paris today?")
